...
<p align="justify">
  While experimenting with legacy react I started to look for ways to create http servers. I made the http server with python. It was quite simple to get the server up and running. Later I came across flask which is a lot nicer to use.
</p>
